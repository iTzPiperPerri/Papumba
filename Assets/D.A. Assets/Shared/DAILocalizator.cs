...
{
    public class DAILocalizator<T> : SingletoneScriptableObject<T> where T : ScriptableObject
    {
        [SerializeField] TextAsset locFile;
        private List<LocItem> localizations;

        public List<LocItem> ConvertFileToLocItems(string csvText)
        {
        ...
        public string Localize(string key, DALanguage lang, params object[] args)
        {
