...
namespace DA_Assets.DAG
{
    ...
    public class DAGradient : BaseMeshEffect
    {
        ...
        [SerializeField] ColorBlendMode blendMode = ColorBlendMode.Overlay;
        [SerializeField, Range(0, 1)] float intensity = 1f;
        [SerializeField, Range(0, 360)] float angle = 0f;

        [DASerialization(nameof(blendMode))]
        ...
        [DASerialization(nameof(intensity))]
        ...
        [DASerialization(nameof(gradient))]
        ...
        public override void ModifyMesh(VertexHelper vertexHelper)
        {
            ...
            for (int i = 0; i < vertexHelper.currentVertCount; i++)
            {
                ...
                uiVertex.color = ColorBlender.Blend(uiVertex.color, gradientColor, blendMode, intensity);
