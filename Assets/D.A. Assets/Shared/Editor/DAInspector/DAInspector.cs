...
namespace DA_Assets.Shared
{
    ...
    public class DAInspector : SingletoneScriptableObject<DAInspector>
    {
        ...
        [SerializeField] int hamburgerMenuItemsLimit = 150;
        ...
        public bool CheckBox(GUIContent label, bool value)
        {
            ...
            DrawGroup(new Group
            {
                ...
                Body = () =>
                {
                    GUILayout.Label(label, GetStyle(GuiStyle.CheckBoxLabel));
        ...
        public bool Button(GUIContent label, WidthType widthType, GuiStyle customStyle)
        {
            ...
            DrawGroup(new Group
            {
                ...
                Body = () =>
                {
                    ...
                    if (btnRect.width > 300 && widthType != WidthType.Expand)
                    {
                        btnRect.width /= 2;
        ...
        public void SpecificSpace(float pixels) => GUILayout.Space(pixels);
