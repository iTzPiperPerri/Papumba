...
namespace DA_Assets.FCU
{
    ...
    public class ProjectImporter : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        public IEnumerator StartImport()
        {
            ...
            List<FObject> allPagesSelectedFrames = GetSelectedFrames();

            FObject virtualPage = new FObject
            {
                Children = allPagesSelectedFrames,
                Data = new SyncData
                {
        ...
        private List<FObject> GetSelectedFrames()
        {
            ...
            List<FObject> allPagesSelectedFrames = childsOfChilds
                .Where(fobject => selected
                .Contains(fobject.Id))
                .ToList();

            return allPagesSelectedFrames;
        }
