...
namespace DA_Assets.FCU.Drawers.CanvasDrawers
{
    ...
    public class I2LocalizationDrawer : MonoBehaviourBinder<FigmaConverterUnity>
    {
        public void AddLanguageSource()
        {
            ...
            if (monoBeh.Settings.MainSettings.UseI2Localization == false)
                return;
        ...
        public void AddI2Localize(FObject fobject)
        {
            ...
            {
                string text = EscapeQuotesForExel(fobject.Characters);
        ...
        {
            string path = $"{Application.dataPath}/{DAConstants.Publisher}/{FcuConfig.ProductName}/{FcuConfig.Instance.LocalizationFileName}";
            CreateLocFile(path);
            return path;
        }
