...
namespace DA_Assets.FCU
{
    ...
    public class ImageTypeSetter : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        private bool IsGenerative(FObject fobject)
        {
            ...
            if (monoBeh.UsingMPUIKit() || monoBeh.UsingProceduralUI_Image() || monoBeh.UsingShapes2D())
            {
        ...
        private bool IsDownloadable(FObject fobject)
        {
            ...
            else if (monoBeh.UsingUnityImage())
            {
            ...
            else if (monoBeh.UsingMPUIKit() || monoBeh.UsingProceduralUI_Image() || monoBeh.UsingShapes2D())
            {
                ...
                else if (fobject.Type == "RECTANGLE" || fobject.Type == "ELLIPSE")
                {
