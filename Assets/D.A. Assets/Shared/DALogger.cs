...
namespace DA_Assets.Shared
{
    public static class DALogger
    {
        ...
        public static bool WriteLogBeforeEqual(ICollection list1, ICollection list2, FcuLocKey locKey, ICollection count1, ICollection count2, ref int tempCount)
        {
            if (list1.Count != list2.Count)
            {
                if (tempCount != list1.Count)
                {
                    ...
                    Log(locKey.Localize(count1.Count, count2.Count));
                }
