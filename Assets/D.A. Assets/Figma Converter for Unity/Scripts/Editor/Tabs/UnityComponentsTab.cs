...
namespace DA_Assets.FCU
{
    internal class UnityComponentsTab : ScriptableObjectBinder<FcuSettingsWindow, FigmaConverterUnity>
    {
        ...
        private DefaultTextSettings defaultTextSettingsTab;
        internal DefaultTextSettings DefaultTextSettingsTab => defaultTextSettingsTab.Bind(scriptableObject, monoBeh);
    }
}